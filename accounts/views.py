...
from .forms import UserRegistrationForm, UserProfileEditForm, UserLoginForm, CreateJobForm
...
from .models import LookUpJob, CustomUser
from accounts.utils import send_otp, generate_jobid, extract_form_data
import phonenumbers
...
def dashboard(request):
    ...
    return render(request, 'dashboard.html', {'profile_type': profile_type, 'password_form': password_form, 'countries_data': countries_data, 'bookmark_data': user_bookmark_data})
